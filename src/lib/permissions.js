...
export const PERMISSIONS = {
  ...
  // Artists
  ARTIST_VIEW: [ROLES.ADMIN, ROLES.EDITOR, ROLES.VIEWER, ROLES.ARTIST],
  ARTIST_CREATE: [ROLES.ADMIN, ROLES.EDITOR],
  ARTIST_EDIT: [ROLES.ADMIN, ROLES.EDITOR],
  ARTIST_DELETE: [ROLES.ADMIN],
  
  // Albums
  ALBUM_VIEW: [ROLES.ADMIN, ROLES.EDITOR, ROLES.VIEWER, ROLES.ARTIST],
  ALBUM_CREATE: [ROLES.ADMIN, ROLES.EDITOR],
  ALBUM_EDIT: [ROLES.ADMIN, ROLES.EDITOR],
  ALBUM_DELETE: [ROLES.ADMIN],
  
  // Tracks
  TRACK_VIEW: [ROLES.ADMIN, ROLES.EDITOR, ROLES.VIEWER, ROLES.ARTIST],
  TRACK_CREATE: [ROLES.ADMIN, ROLES.EDITOR],
  TRACK_EDIT: [ROLES.ADMIN, ROLES.EDITOR],
  TRACK_DELETE: [ROLES.ADMIN],
